...
public interface FriendshipRepository extends JpaRepository<Friendship, FriendshipId> {
    ...
    Optional<Friendship> findFriendshipBetween(@Param("user1") Long user1, @Param("user2") Long user2);
    ...
    List<Long> findFriendsIdsByStatus(@Param("userId") Long userId, @Param("status") FriendshipStatus status);
    ...
    List<Long> findIncomingRequests(@Param("userId") Long userId, @Param("status") FriendshipStatus status);
}